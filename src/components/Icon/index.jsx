...
export const PenIcon = ({ size = 14, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SaveIcon = ({ size = 14, ...props }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const DownIcon = ({ size = 14, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const UpIcon = ({ size = 14, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const LeftIcon = ({ size = 14, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const DoubleLeftIcon = ({ size = 14, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const RightIcon = ({ size = 14, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const DoubleRightIcon = ({ size = 14, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const FileUpload = ({ size = 14, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const PdfIcon = ({ size = 20, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
    <polyline points="14 2 14 8 20 8" />
    <text strokeWidth="0.5" x="8" y="17" fontSize="8" fill="currentColor">
      PDF
    </text>
  </svg>
);

export const ExcelIcon = ({ size = 20, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
    <polyline points="14 2 14 8 20 8" />
    <text strokeWidth="0.5" x="6" y="17" fontSize="6" fill="currentColor">
      XLS
    </text>
  </svg>
);

export const WordIcon = ({ size = 20, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const VideoIcon = ({ size = 24, color = "currentColor", ...props }) => (
  <svg
    ...
    {...props}
  >
    <rect x="2" y="4" width="20" height="16" rx="2" ry="2" stroke={color} />
    <polygon points="10 9 16 12 10 15 10 9" fill={color} />
  </svg>
);

export const GenericFileIcon = ({ size = 20, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const FilterIcon = ({ size = 16, color = "currentColor", ...props }) => (
  <svg
    width={size}
    height={size}
    fill="none"
